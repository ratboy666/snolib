...
*
         ...
         CT = TIME() - CT
*
* NOW WE CAN PRINT THE LIGHTNING CODE, OR DISASSEMBLE. WE CAN OBTAIN
* ENTRY POINTS DEFINED WITH THE 'ADDRESS' DIRECTIVE OR THE ENTIRE
* OBJECT CODE BLOCK WITH OBJ(ASM).
*
