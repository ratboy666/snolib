...
<p align="justify">
  ...
  I find <i>RCS</i> entirely suitable. However, SNOLIB now uses GIT,
  because the project is hosted on github.
  <a href="https://github.com/ratboy666/snolib">github SNOLIB</a>
